...
#ifndef __NAP1_SENSOR_ARRAY_H__
#define __NAP1_SENSOR_ARRAY_H__
...
class NAP1_Sensor_Array
{
public:
    // Construct individual sensor objects, but don't yet initialize the array
    NAP1_Sensor_Array(uint8_t dht_pin, uint8_t dht_type);
...
private:
    NAP1_Sensor_Array(const NAP1_Sensor_Array&) = delete;
    ...
    Adafruit_Sensor* _sensors[DHT_CNT*2];
    uint8_t _sensor_cnt;
